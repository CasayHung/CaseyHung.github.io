...
// Variable
var empityVar; // A statement that creates a variable called "emptVar"
console.log(empityVar); //undefined
...
//var badQuotation ='Ah"; // Different quotation mark cause errors.

var x = 'This is a variable called x'; // Change the value to a different type of data; not recommanded
//console.log(x)